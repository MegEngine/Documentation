...
.. dropdown:: :fa:`eye,mr-1` 异或问题，人工智能的第一次寒冬
   ...
   **尝试一下，设计出一个最简单的神经网络模型，要求能够正确地预测异或计算的输出。**

   有兴趣的话，可以去了解一下人工智能的发展历史，一些纪录片和文章相当引人入胜。

.. dropdown:: :fa:`eye,mr-1` 没有 Autodiff, Optimizer 和 Module 的时代

   学习一个东西的最快办法之一是亲自去实现它，哪怕是 Naive 版本。

   你可以尝试完全使用 NumPy 实现一个全连接神经网络，
   可以选择参考 MegEngine 中已有的设计进行实现，也可以完全自由发挥。
